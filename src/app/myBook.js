...
/**
    ...
    _getPublishedBooks: function () {
        return new Promise(function (resolve, reject) {
            book.deployed().then(function (bookInstance) {
                bookInstance.getPublishedBooks.call({from: web3.eth.accounts[0]}).then(function (result) {
                    resolve(result);
                }).catch(function (err) {
                    alert("内部错误:getPublishedBooks " + err);
                });
            });
        });
    },
    ...
    _getCommentedBooks: function () {
        return new Promise(function (resolve, reject) {
            book.deployed().then(function (bookInstance) {
                bookInstance.getCommentedBook.call({from: web3.eth.accounts[0]}).then(function (result) {
                    resolve(result);
                }).catch(function (err) {
                    alert("内部错误: _getCommentedBooks" + err);
                });
            });
        });
    },
    ...
    _getBorrowedBooks: function () {
        return new Promise(function (resolve, reject) {
            book.deployed().then(function (bookInstance) {
                bookInstance.getBorrowedBooks.call({from: web3.eth.accounts[0]}).then(function (result) {
                    resolve(result);
                }).catch(function (err) {
                    alert("内部错误: _getBorrowedBooks" + err);
                });
            });
        });
    },
    ...
    _getReturnedBooks: function () {
        return new Promise(function (resolve, reject) {
            book.deployed().then(function (bookInstance) {
                bookInstance.getReturnedBooks.call({from: web3.eth.accounts[0]}).then(function (result) {
                    resolve(result);
                }).catch(function (err) {
                    alert("内部错误: _getReturnedBooks" + err);
                });
            });
        });
    },
        ...
        return new Promise(function (resolve, reject) {
            book.deployed().then(function (bookInstance) {
                bookInstance.getBooksLength.call().then(function (result) {
                    ...
                    alert("内部错误: _getBooksLength" + err);
                });
            });
        });
    },
    ...
    _getBookInfo: function (id) {
        return new Promise(function (resolve,reject) {
            book.deployed().then(function (bookInstance) {
                bookInstance.getBookInfo.call(Number(id)).then(function (result) {
                    resolve(result);
                }).catch(function (err) {
                    alert("内部错误: _getBookInfo"+err);
                });
            });
        });
    }
